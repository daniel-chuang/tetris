...
Version GTetris: Added gerrymandering scoring. Added red and blue coloring. Added instructions.
...
def main():
    ...
    while not crashed:
        ...
        if gameStage == 0:
            ...
            screen.BlitText("TAB to Rotate Tetromino", (10, 110), (255, 255, 255), 15)
