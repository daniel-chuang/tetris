...
Version GTetris 3: Added gameover + retry screen."""
...
def main():
    ...
    while not crashed:
        ...
        if gameStage == 0:
            # Start Screen
            screen.BlitText("Tetris: Gerrymandering",
                            (10, 10), (255, 255, 255), 25)
            screen.BlitText("Controls:", (10, 40), (255, 255, 255), 25)
            screen.BlitText("LEFT + RIGHT to Shift Tetromino",
                            (10, 70), (255, 255, 255), 15)
            screen.BlitText("DOWN or SPACE to Drop Tetromino Fast",
                            (10, 90), (255, 255, 255), 15)
            screen.BlitText("Q and W to Rotate Tetromino",
                            (10, 110), (255, 255, 255), 15)
            screen.BlitText("Instructions:", (10, 150), (255, 255, 255), 25)
            screen.BlitText(
                "Fill up an entire row with blocks to clear", (10, 180), (255, 255, 255), 15)
            screen.BlitText("it and get points!",
                            (10, 200), (255, 255, 255), 15)
            screen.BlitText("Here's where things get interesting:",
                            (10, 220), (255, 255, 255), 15)
            screen.BlitText("You will be simulating gerrymandering",
                            (10, 240), (255, 255, 255), 15)
            screen.BlitText("a common practice used by politicians",
                            (10, 260), (255, 255, 255), 15)
            screen.BlitText("to abuse the majority takes all",
                            (10, 280), (255, 255, 255), 15)
            screen.BlitText("voting system by just barely winning",
                            (10, 300), (255, 255, 255), 15)
            screen.BlitText(
                "the majority in many regions, essentially", (10, 320), (255, 255, 255), 15)
            screen.BlitText("making votes in their favor carry",
                            (10, 340), (255, 255, 255), 15)
            screen.BlitText(
                "more weight! In this case, votes in your", (10, 360), (255, 255, 255), 15)
            screen.BlitText(
                "favor are orange. If half or more of the", (10, 380), (255, 255, 255), 15)
            screen.BlitText("blocks in a completed row are orange,",
                            (10, 400), (255, 255, 255), 15)
            screen.BlitText("you will get three times the points!",
                            (10, 420), (255, 255, 255), 15)
            screen.BlitText("Click on the screen and press",
                            (10, 460), (255, 255, 255), 15)
            screen.BlitText("SPACE to start playing.",
                            (10, 480), (255, 255, 255), 15)
            screen.Display()
            keys = pygame.key.get_pressed()
        ...
        # Game over screen.
            ...
            pygame.display.update()
            screen.screen.fill(screen.fillcolor)
            screen.BlitText("Game over!", (10, 10), (255, 255, 255), 25)
            screen.BlitText("You got {} points.".format(
                grid.score), (10, 40), (255, 255, 255), 25)
            screen.BlitText("Press SPACE to play again.".format(
                grid.score), (10, 70), (255, 255, 255), 15)
            keys = pygame.key.get_pressed()
            if keys[pygame.K_SPACE]:
                time.sleep(0.5)
                break
